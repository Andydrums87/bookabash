...
const Nav = () => {
  ...
  return (
     <header className="bg-white border-b border-gray-100 relative z-30 ">
            <div className="container px-6 py-3 flex items-center justify-between min-w-screen">
              <div className="flex items-center space-x-2">
                <Link href="/">
                  <div className="h-20 w-auto relative">
                    <Image src="https://res.cloudinary.com/dghzq6xtd/image/upload/v1748440622/logo-darker_jhviti.png" alt="BookABash" width={200} height={90} className="object-contain" />
                  </div>
                </Link>
              </div>
              ...
              <nav className="hidden md:flex items-center space-x-8">
                <Link href="/browse" className="text-gray-700 hover:text-[#FC6B57] font-medium transition-colors">
                  Browse Suppliers
                </Link>
                <Link href="/dashboard" className="text-gray-700 hover:text-[#FC6B57] font-medium transition-colors">
                  My Events
                </Link>
                <Link href="/help" className="text-gray-700 hover:text-[#FC6B57] font-medium transition-colors">
                  Help
                </Link>
                <Link href="/blog" className="text-gray-700 hover:text-[#FC6B57] font-medium transition-colors">
                  Blog
                </Link>
                <Link
                  href="/suppliers/onboarding"
                  className="text-primary-500 hover:text-[#FC6B57] font-medium transition-colors"
                >
                  List with us
                </Link>
