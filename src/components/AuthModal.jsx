        ...
        <div className={isSignUp ? "md:grid md:grid-cols-[1fr,320px] md:gap-6" : ""}>
          ...
          <div className="space-y-2">
            ...
            <Button
              ...
              className="w-full h-11 bg-white hover:bg-gray-50 border-2 border-primary-500 rounded-full font-medium text-gray-700"
            >
              {oauthLoading === "google" ? (
            ...
            <Button
              ...
              disabled={loading || oauthLoading}
              className="w-full h-11 bg-gray-800 hover:bg-gray-700 text-white rounded-full font-medium"
            >
              {oauthLoading === "apple" ? (
                <Loader2 className="h-5 w-5 animate-spin mr-2" />
              ) : (
