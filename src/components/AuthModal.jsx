        ...
        <div className={isSignUp ? "md:grid md:grid-cols-[1fr,320px] md:gap-6" : ""}>
          ...
          <div className="space-y-2">
            ...
            <Button
              ...
              disabled={loading || oauthLoading}
              className="w-full h-10 bg-black hover:bg-gray-900 text-white rounded-lg border-0 font-medium"
            >
              {oauthLoading === "apple" ? (
            ...
            <Button
              ...
              disabled={loading || oauthLoading}
              className="w-full h-10 bg-gray-100 hover:bg-gray-200 border-0 rounded-lg font-medium text-gray-700"
            >
              {oauthLoading === "google" ? (
                <Loader2 className="h-4 w-4 animate-spin mr-2" />
              ) : (
