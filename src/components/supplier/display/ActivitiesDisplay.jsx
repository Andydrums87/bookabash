...
const ActivitiesDisplay = ({ supplier, serviceDetails }) => {
  console.log('🎪 ActivitiesDisplay received:', { supplier: supplier?.name, serviceDetails });
    ...
    <div className="space-y-6">
      ...
      <Card className="border-gray-300">
        <CardContent className="p-6">
          ...
          {serviceDetails.capacities?.length > 0 && (
            <div className="mb-6">
              <h4 className="font-semibold text-gray-900 mb-3 flex items-center gap-1">
              ...
              <div className="flex flex-wrap gap-2">
                {serviceDetails.capacities.map((capacity, index) => (
