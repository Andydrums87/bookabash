...
export function SupplierForm() {
  ...
  const inputClasses = "p-6 text-base mt-1 bg-white dark:bg-slate-700 border-slate-400 dark:border-slate-600 text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:ring-[hsl(var(--primary-500))] focus:border-[hsl(var(--primary-500))] rounded-md shadow-sm"
...
<div className="mt-6">
  ...
  <div className="grid grid-cols-2 gap-4 mt-4">
    <Button 
      ...
      onClick={() => {
        if (!termsAccepted) {
          setTermsError(true)
          document.getElementById('basic-terms-acceptance')?.scrollIntoView({ 
            behavior: 'smooth', 
            block: 'center' 
          })
          return
      ...
      disabled={loading}
      className={`border-gray-300 hover:bg-gray-50 transition-opacity ${
  ...
  {/* Helper text when terms not accepted */}
  {!termsAccepted && (
    <p className="text-xs text-center text-primary-500 mt-3 font-medium">
