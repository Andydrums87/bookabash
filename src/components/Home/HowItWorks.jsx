      ...
      {steps.map((step, index) => (
        <section
          ...
          className={`relative overflow-hidden ${
            step.darkBg
              ? 'pt-16 pb-16 md:py-14 bg-gradient-to-br from-[hsl(var(--primary-400))] via-[hsl(var(--primary-500))] to-[hsl(var(--primary-600))]'
              : 'py-6 md:py-14 bg-white'
          }`}
        >
          {/* Wave divider at top of orange sections */}
          {step.darkBg && (
            <div className="absolute top-0 left-0 right-0 overflow-hidden leading-none">
              {/* Mobile: 2 larger waves */}
              <svg
                className="relative block w-full h-12 md:hidden"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 1200 120"
                preserveAspectRatio="none"
              >
                <path
                  d="M0,0 V50 Q300,110 600,50 Q900,-10 1200,50 V0 Z"
                  fill={index === 0 ? "#fef7f7" : "white"}
                />
              </svg>
              {/* Desktop: more detailed wave */}
              <svg
                className="relative hidden md:block w-full h-12"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 1200 120"
                preserveAspectRatio="none"
              >
          ...
          {/* Wave divider at bottom of orange sections */}
          {step.darkBg && (
