  ...
  style={{
    boxShadow: '0 10px 40px rgba(255, 107, 107, 0.1), 0 4px 20px rgba(0, 0, 0, 0.05)'
          ...
          <Image
            src="https://res.cloudinary.com/dghzq6xtd/image/upload/v1752828180/ChatGPT_Image_Jul_18_2025_09_42_44_AM_k0a9wh.png" // Replace with your Snappy image URL
...
<div className="px-6 mb-8 relative">
  <div className="relative w-full h-40 bg-gradient-to-br from-[hsl(var(--primary-300))] to-[hsl(var(--primary-400))] rounded-3xl overflow-hidden mx-auto max-w-sm shadow-xl transform hover:scale-105 transition-transform duration-300">
    <Image
      src="https://res.cloudinary.com/dghzq6xtd/image/upload/v1752828017/iStock-1149320278_srn8ti-removebg-preview_njfbhn.png"
      alt="People celebrating at a party"
      fill
...
{/* Call to Action with Snappy - Fixed Position */}
<div className="fixed bottom-10 left-1/2 transform -translate-x-1/2 z-50">
  <button 
    onClick={() => {
      document.getElementById('mobile-form')?.scrollIntoView({ behavior: 'smooth' });
    }}
    className="bg-white hover:bg-gray-50 text-[hsl(var(--primary-500))] font-bold h-16 w-64 sm:w-72 rounded-full transition-all duration-300 transform hover:scale-105 relative overflow-hidden group border-2 border-[hsl(var(--primary-500))] animate-bounce-gentle shadow-lg hover:shadow-2xl"
    style={{
