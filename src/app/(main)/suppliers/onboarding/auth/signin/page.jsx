...
import SupplierSignInContent from './SupplierOnboardingSignIn'
// Loading component for the suspense fallback
function SupplierSignInPageLoading() {
  return (
...
export default function SupplierSignInPage() {
  return (
    <Suspense fallback={<SupplierSignInPageLoading />}>
      <SupplierSignInContent />
    </Suspense>
  )
}