    ...
    <div className="min-h-screen bg-white dark:bg-slate-900 text-gray-900 dark:text-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 text-center lg:text-left">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-gray-900 dark:text-white">
                ...
                <span className="text-primary-600 dark:text-primary-400">BookABash</span>
              </h1>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900 dark:text-white">
              Why Partner with <span className="text-primary-600 dark:text-primary-400">BookABash</span>?
            </h2>
      ...
      <section className="py-16 md:py-24 bg-gray-100 dark:bg-slate-800">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900 dark:text-white">
              See <span className="text-primary-600 dark:text-primary-400">BookABash</span> in Action
            </h2>
            <p className="text-lg text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
      ...
      <section className="py-16 md:py-24 bg-white dark:bg-slate-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900 dark:text-white">
              Transform Your Business with <span className="text-primary-600 dark:text-primary-400">BookABash</span>
            </h2>
            <p className="text-lg text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
