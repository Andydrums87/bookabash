...
import SnappyChatReviewPage from './components/SnappyChatReviewPage'
import { Loader2 } from "lucide-react"

// Loading component for Suspense fallback
function ReviewBookLoading() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-primary-100 to-primary-200 overflow-hidden relative -mt-16 pt-16">
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center p-6">
        <div className="text-center space-y-4">
          ...
          <h2 className="text-2xl font-bold text-gray-900">Loading your Enquiries...</h2>
...
export default function ReviewBookPage() {
  return (
    <Suspense fallback={<ReviewBookLoading />}>
   <SnappyChatReviewPage />
    </Suspense>
  )
}