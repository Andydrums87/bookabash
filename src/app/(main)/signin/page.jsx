...
export default function SignInPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (email === "supplier@example.com") {
      ...
      setError(
        "Invalid email or password. Try 'supplier@example.com' (any password) for supplier access, or any other valid email for customer access.",
      )
      setIsLoading(false)
    }
  }
        ...
        <Card className="w-full max-w-md shadow-xl border-gray-200">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    ...
                    className={`text-sm text-primary-600 hover:text-primary-700 hover:underline ${isLoading ? "pointer-events-none opacity-50" : ""}`}
          ...
          <CardFooter className="flex flex-col items-center space-y-4 pt-6">
            ...
            <div className="grid grid-cols-2 gap-4 w-full">
              <Button variant="outline" className="w-full border-gray-300 hover:bg-gray-300" disabled={isLoading}>
            ...
            <p className="mt-6 text-center text-sm text-gray-600 pb-10">
              ...
              <Link
                href="/signup"
                className={`font-medium text-primary-600 hover:text-primary-700 hover:underline ${isLoading ? "pointer-events-none opacity-50" : ""}`}
                aria-disabled={isLoading}
                tabIndex={isLoading ? -1 : undefined}
              >
                Sign Up
