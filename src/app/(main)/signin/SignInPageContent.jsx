        ...
        <Card className="w-full max-w-md shadow-xl border-gray-200">
          ...
          <CardFooter className="flex flex-col items-center space-y-4 pt-6">
            ...
            <div className="w-full space-y-2">
              ...
              <Button
                variant="outline"
                className="w-full h-11 bg-white hover:bg-gray-50 border-2 border-primary-500 rounded-full font-medium text-gray-700 text-base"
                disabled={isLoading || oauthLoading}
              ...
              {/* Apple - Dark solid */}
              <Button
                className="w-full h-11 bg-gray-800 hover:bg-gray-700 text-white rounded-full font-medium text-base"
                disabled={isLoading || oauthLoading}
