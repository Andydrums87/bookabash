        ...
        <Card className="w-full max-w-md shadow-xl border-gray-200">
          ...
          <CardFooter className="flex flex-col items-center space-y-4 pt-6">
            ...
            <div className="w-full space-y-2">
              ...
              <Button
                className="w-full h-11 bg-black hover:bg-gray-900 text-white rounded-lg border-0 font-medium"
                disabled={isLoading || oauthLoading}
              ...
              {/* Google - Gray full width */}
              <Button
                variant="outline"
                className="w-full h-11 bg-gray-100 hover:bg-gray-200 border-0 rounded-lg font-medium text-gray-700"
                disabled={isLoading || oauthLoading}
