...
import CleanGiftRegistryPreview from '../components/GiftRegistryPreview'
import { Loader2 } from "lucide-react"

// Loading component for Suspense fallback
function GiftRegistryPreviewLoading() {
  return (
...
export default function Page() {
  return (
    <Suspense fallback={<GiftRegistryPreviewLoading />}>
      <CleanGiftRegistryPreview />
    </Suspense>
  )
}