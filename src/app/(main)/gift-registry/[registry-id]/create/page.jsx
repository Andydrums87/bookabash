...
import GiftRegistryShop from '../components/GiftRegistryCreate'
import { Loader2 } from "lucide-react"

// Loading component for Suspense fallback
function GiftRegistryLoading() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[hsl(var(--primary-50))] via-white to-[hsl(var(--primary-100))]">
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center space-y-4">
          ...
          <h2 className="text-2xl font-bold text-gray-900">Loading shop...</h2>
...
export default function Page() {
  return (
    <Suspense fallback={<GiftRegistryLoading />}>
      <GiftRegistryShop/>
    </Suspense>
  )
}