...
import { Mail, Gift, X, CheckCircle, Clock, Loader2, Send } from "lucide-react"
...
export default function SupplierCard({ 
          ...
          overlayContent: (
            <div className="absolute inset-0 bg-yellow-50/80 backdrop-blur-sm z-30 flex items-center justify-center">
              <div className="text-center p-6">
                ...
                <h3 className="text-lg font-semibold text-yellow-800 mb-2">Awaiting Response</h3>
                <p className="text-sm text-yellow-700 mb-4">
                  We've sent your enquiry to {supplier.name}
                </p>
                <div className="flex items-center justify-center space-x-2 text-xs text-yellow-600 mb-4">
          ...
          overlayContent: (
            <div className="absolute inset-0 bg-red-50/80 backdrop-blur-sm z-30 flex items-center justify-center">
              <div className="text-center p-6">
                ...
                <h3 className="text-lg font-semibold text-red-800 mb-2">Declined</h3>
  ...
  return (
    <Card className={`overflow-hidden rounded-lg border shadow-sm transition-all duration-300 relative ${
        ...
        {isLoading ? (
          ...
          <>
            <div className="absolute top-[-24px] left-0 w-full h-full">
              <div
                className={`relative w-[100%] h-[100%] mask-image mx-auto mt-10 transition-all duration-300 ${
            ...
            <div className={`absolute px-4 py-2 top-2 rounded-full left-3 flex items-center space-x-2 text-white text-xs z-10 ${
      ...
      <CardContent className={`px-4 pb-5 transition-all duration-300`}>
        {isLoading ? (
          <>
