// AwaitingResponseSupplierCard.js - Option 4: Border & Badge System
"use client"
  ...
  return (
    <Card className={`gap-0 overflow-hidden rounded-2xl shadow-xl transition-all duration-300 relative min-h-[480px] ${isDeleting ? "opacity-50 scale-95" : ""} 
      ...
      <div className="absolute top-5 left-1/2 transform -translate-x-1/2 z-20">
        <Badge className="bg-[hsl(var(--primary-500))] text-white px-4 py-1 text-sm font-medium animate-pulse shadow-lg">
      ...
      <div className="bg-gradient-to-br from-gray-50 to-gray-100 flex-1">
        <div className="p-5">
          ...
          <Button
            ...
            className="w-full border-gray-300 text-gray-700 hover:bg-gray-200 bg-white/80"
          >
            Cancel Request
          </Button>
        </div>
