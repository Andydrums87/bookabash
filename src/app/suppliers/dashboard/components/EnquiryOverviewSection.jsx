  ...
  return (
    <div>
      ...
      <Card>
        ...
        <CardContent>
          {/* Desktop Table View - Mobile optimized headers */}
                      ...
                      >
                        <td className="p-3 sm:p-4 font-medium">
                          <div className="flex flex-col gap-1">
                            <div className="flex items-center gap-2">
                              {isDepositPaid && <span className="text-red-600 font-bold text-sm">🚨</span>}
                              <span className="text-sm sm:text-base">{lead.service}</span>
                              {!lead.processed && (
                                <AlertTriangle
                                ...
                                addons.length > 0 && (
                                  <div className="space-y-1">
                                    ...
                                    <div className="pl-4 space-y-0.5">
                                      ...
                                      {addons.length > 2 && (
                                        <div className="text-xs text-gray-500">... and {addons.length - 2} more</div>
                                      )}
                                    </div>
                          ...
                          <div className="flex gap-2">
                            {isDepositPaid ? (
                              <Link href={`/suppliers/enquiries/${lead.id}`}>
                                <Button
                                  size="sm"
                                  className="bg-red-600 hover:bg-red-700 text-white animate-pulse text-xs"
                                >
                                  🚨 RESPOND NOW
                                </Button>
                              </Link>
        ...
        >
          ...
          {leads.length === 0 && summary.total === 0 && (
            <div className="p-6 sm:p-8 lg:p-12 text-center">
              <Users className="mx-auto h-8 w-8 sm:h-10 sm:w-10 lg:h-12 lg:w-12 text-gray-400 mb-4" />
              <h3 className="text-sm sm:text-base lg:text-lg font-medium text-gray-900 mb-2">No enquiries yet</h3>
          ...
          {/* All Data Invalid State - Mobile optimized */}
          {leads.length === 0 && summary.total > 0 && (
            <div className="p-6 sm:p-8 lg:p-12 text-center">
              <AlertTriangle className="mx-auto h-8 w-8 sm:h-10 sm:w-10 lg:h-12 lg:w-12 text-yellow-500 mb-4" />
              <h3 className="text-sm sm:text-base lg:text-lg font-medium text-gray-900 mb-2">Data Processing Issues</h3>
          ...
          {/* Data Quality Summary - Mobile optimized */}
          {summary.total > 0 && errors.length > 0 && (
            <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
              <div className="flex items-center gap-2 text-yellow-800">
                <AlertTriangle className="w-4 w-4" />
                <span className="text-xs sm:text-sm font-medium">Data Quality Report</span>
              </div>
