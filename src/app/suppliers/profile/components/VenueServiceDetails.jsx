 ...
 <Card className="">
    ...
    return words.length;
      ...
      <Card>
        ...
        <CardContent className="p-8 space-y-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="space-y-3">
              <Label htmlFor="venueType" className="text-base font-semibold text-gray-700">
          ...
          {supplierData?.owner?.address && (
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6">
              ...
              <p className="text-blue-800">
                {supplierData.owner.address.street}, {supplierData.owner.address.city}, {supplierData.owner.address.postcode}
              </p>
              <p className="text-sm text-blue-600 mt-1">
                ✓ This address will be used for your venue location
              </p>
            </div>
          )}
      ...
      <Card>
        ...
        <CardContent className="p-8 space-y-8">
          <div>
            <h4 className="font-semibold text-gray-900 mb-4">Available Facilities</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {facilityOptions.map(facility => (
                <div key={facility} className="flex items-center space-x-3 p-4 bg-gray-50 rounded-xl hover:bg-green-50 transition-colors">
                  <Checkbox
                    ...
                    className="w-5 h-5"
                  />
                  <Label htmlFor={`facility-${facility}`} className="text-base font-medium cursor-pointer flex-1">
                    {facility}
                  </Label>
                </div>
              ))}
          ...
          <div>
            <h4 className="font-semibold text-gray-900 mb-4">Equipment Quantities</h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
              {[
                ...
                <div key={item.key} className="flex items-center space-x-3 p-4 bg-gray-50 rounded-xl hover:bg-green-50 transition-colors">
                  <Checkbox
        ...
        <CardContent className="p-8">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {ageGroupOptions.map(age => (
              <div key={age} className="flex items-center space-x-3 p-4 bg-gray-50 rounded-xl hover:bg-purple-50 transition-colors">
                <Checkbox
                  id={`age-${age}`}
      ...
      <Card>
        <CardHeader className="p-8 bg-gradient-to-r from-orange-50 to-orange-100">
          ...
          <CardDescription className="text-base">
            Set your rates and any additional fees
          </CardDescription>
        </CardHeader>
        <CardContent className="p-8 space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="space-y-3">
              ...
              <Input
                ...
                onChange={(e) => handleNestedFieldChange('pricing', 'halfDayRate', parseInt(e.target.value))}
                className="h-12 bg-white border-2 border-gray-200 rounded-xl text-base"
                placeholder="200"
              />
            </div>
            ...
            <div className="space-y-3">
              ...
              <Input
                ...
                onChange={(e) => handleNestedFieldChange('pricing', 'fullDayRate', parseInt(e.target.value))}
                className="h-12 bg-white border-2 border-gray-200 rounded-xl text-base"
                placeholder="350"
              />
            </div>
      ...
      <Card>
        <CardHeader className="p-8 bg-gradient-to-r from-red-50 to-red-100">
          ...
          <CardDescription className="text-base">
            Set clear expectations for venue usage
          </CardDescription>
        </CardHeader>
        <CardContent className="p-8 space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <div key={policy.key} className="flex items-center space-x-3 p-4 bg-gray-50 rounded-xl hover:bg-red-50 transition-colors">
                <Checkbox
                  ...
                  className="w-5 h-5"
                />
                <Label htmlFor={`policy-${policy.key}`} className="text-base font-medium cursor-pointer flex-1">
                  {policy.label}
                </Label>
              </div>
            ))}
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {setupOptions.map(setup => (
                <div key={setup} className="flex items-center space-x-3 p-4 bg-gray-50 rounded-xl hover:bg-indigo-50 transition-colors">
                  <Checkbox
                    id={`setup-${setup}`}
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {cateringOptions.map(option => (
                <div key={option} className="flex items-center space-x-3 p-4 bg-gray-50 rounded-xl hover:bg-indigo-50 transition-colors">
                  <Checkbox
                    id={`catering-${option}`}
