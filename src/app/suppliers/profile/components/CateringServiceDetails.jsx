...
const CateringServiceDetails = ({ serviceDetails, onUpdate, saving, supplierData, currentBusiness }) => {
  ...
  const addonTemplates = [
    { name: 'Extra Staff Member', price: 80, description: 'Additional serving staff for your event', category: 'service' },
    { name: 'Premium Setup Service', price: 60, description: 'Full table setup with linens and decorations', category: 'service' },
    { name: 'Custom Birthday Cake', price: 45, description: 'Personalized birthday cake with name and age', category: 'specialty' },
    { name: 'Gluten-Free Options', price: 25, description: 'Alternative menu items for gluten-free guests', category: 'dietary' },
    { name: 'Extra Portions (10 people)', price: 120, description: 'Additional food for 10 more guests', category: 'food' },
    ...
    { name: 'Vegan Menu Options', price: 30, description: 'Complete vegan alternatives for dietary requirements', category: 'dietary' }
  ];
 ...
 <Card className="">
    ...
    return words.length;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="space-y-3">
              ...
              <Input
                ...
                onChange={(e) => handleNestedFieldChange('capacity', 'minimum', parseInt(e.target.value))}
            ...
            <div className="space-y-3">
              ...
              <Input
                ...
                onChange={(e) => handleNestedFieldChange('capacity', 'maximum', parseInt(e.target.value))}
                className="h-12 bg-white border-2 border-gray-200 rounded-xl text-base"
                placeholder="200"
              />
            </div>
            ...
            <div className="space-y-3">
              ...
              <Input
                ...
                onChange={(e) => handleNestedFieldChange('leadTime', 'minimum', parseInt(e.target.value))}
                className="h-12 bg-white border-2 border-gray-200 rounded-xl text-base"
                placeholder="24"
              />
            </div>
      ...
      {details.cateringType && !['Birthday Cake Specialist', 'Custom Cake Designer', 'Dessert Specialist'].includes(details.cateringType) && (
        <Card>
          <CardHeader className="p-8 bg-gradient-to-r from-red-50 to-red-100">
            ...
            <CardDescription className="text-base">
              What types of food and specialties do you offer?
            </CardDescription>
          </CardHeader>
          <CardContent className="p-8 space-y-8">
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {cuisineTypes.map(cuisine => (
                  <div key={cuisine} className="flex items-center space-x-3 p-4 bg-gray-50 rounded-xl hover:bg-red-50 transition-colors">
                    <Checkbox
                      id={`cuisine-${cuisine}`}
                      ...
                      className="w-5 h-5"
                    />
                    <Label htmlFor={`cuisine-${cuisine}`} className="text-base font-medium cursor-pointer flex-1">
                      {cuisine}
                    </Label>
                  </div>
                ))}
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {specialtyOptions.map(specialty => (
                  <div key={specialty} className="flex items-center space-x-3 p-4 bg-gray-50 rounded-xl hover:bg-red-50 transition-colors">
                    <Checkbox
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={specialty} className="flex items-center space-x-3 p-4 bg-gray-50 rounded-xl hover:bg-pink-50 transition-colors">
                    <Checkbox
                      ...
                      className="w-5 h-5"
                    />
                    <Label htmlFor={`cake-specialty-${specialty}`} className="text-base font-medium cursor-pointer flex-1">
                      {specialty}
                    </Label>
                  </div>
                ))}
            ...
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {[
                  ...
                  <div key={flavor} className="flex items-center space-x-3 p-4 bg-gray-50 rounded-xl hover:bg-pink-50 transition-colors">
                    <Checkbox
                      id={`flavor-${flavor}`}
                      ...
                      className="w-5 h-5"
                    />
                    <Label htmlFor={`flavor-${flavor}`} className="text-base font-medium cursor-pointer flex-1">
                      {flavor}
                    </Label>
                  </div>
                ))}
        ...
        <CardContent className="p-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {dietaryOptions.map(diet => (
              <div key={diet} className="flex items-center space-x-3 p-4 bg-gray-50 rounded-xl hover:bg-green-50 transition-colors">
                <Checkbox
                  id={`diet-${diet}`}
      ...
      <Card>
        <CardHeader className="p-8 bg-gradient-to-r from-blue-50 to-blue-100">
          ...
          <CardDescription className="text-base">
            What age groups and event types do you specialize in?
          </CardDescription>
        </CardHeader>
        <CardContent className="p-8 space-y-8">
          <div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {eventTypeOptions.map(event => (
                <div key={event} className="flex items-center space-x-3 p-4 bg-gray-50 rounded-xl hover:bg-blue-50 transition-colors">
                  <Checkbox
                    id={`event-${event}`}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="space-y-3">
              ...
              <Input
                ...
                onChange={(e) => handleNestedFieldChange('pricing', 'priceFrom', parseFloat(e.target.value))}
                className="h-12 bg-white border-2 border-gray-200 rounded-xl text-base"
                placeholder="15.00"
              />
            </div>
            ...
            <div className="space-y-3">
              ...
              <Input
                ...
                onChange={(e) => handleNestedFieldChange('pricing', 'priceTo', parseFloat(e.target.value))}
                className="h-12 bg-white border-2 border-gray-200 rounded-xl text-base"
                placeholder="50.00"
              />
            </div>
            ...
            <div className="space-y-3">
              ...
              <Input
                ...
                onChange={(e) => handleNestedFieldChange('pricing', 'minimumOrder', parseInt(e.target.value))}
                className="h-12 bg-white border-2 border-gray-200 rounded-xl text-base"
                placeholder="100"
              />
            </div>
      ...
      <Card>
        ...
        <CardContent className="p-8 space-y-8">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {licenseOptions.map(license => (
                <div key={license} className="flex items-center space-x-3 p-4 bg-gray-50 rounded-xl hover:bg-yellow-50 transition-colors">
                  <Checkbox
                    id={`license-${license}`}
                    ...
                    className="w-5 h-5"
                  />
                  <Label htmlFor={`license-${license}`} className="text-base font-medium cursor-pointer flex-1">
                    {license}
                  </Label>
                </div>
              ))}
          ...
          <div className="space-y-3">
            <Label className="text-base font-semibold text-gray-700">
              Your signature dish or specialty
            </Label>
            <Textarea
          ...
          <div className="space-y-3">
            <Label className="text-base font-semibold text-gray-700">
              What inspired you to start catering?
            </Label>
            <Textarea
          ...
          <div className="space-y-3">
            <Label className="text-base font-semibold text-gray-700">
              Your story & what makes you special
            </Label>
            <Textarea
