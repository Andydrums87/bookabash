...
const TimeSlotAvailabilityContent = ({
  ...
  useEffect(() => {
    const loadAvailabilityData = () => {
      if (currentSupplier) {
        console.log("=== DEBUGGING UNAVAILABLE DATES ===")
        console.log("Raw currentSupplier data:", currentSupplier)
        console.log("currentSupplier.unavailableDates:", currentSupplier.unavailableDates)
        console.log("Type of unavailableDates:", typeof currentSupplier.unavailableDates)
        console.log("Is array:", Array.isArray(currentSupplier.unavailableDates))
        ...
        if (!isPrimaryBusiness && primaryBusiness) {
          console.log("INHERITANCE: Primary business data:", primaryBusiness.data)
          console.log("INHERITANCE: Primary unavailableDates:", primaryBusiness.data?.unavailableDates)
        ...
        console.log("Effective supplier unavailableDates:", effectiveSupplier.unavailableDates)
            ...
            <CardContent className="p-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-800 mb-3">{config?.description || 'Availability based on specific time slots and working hours'}</p>
                  <div className="text-sm text-blue-700">
                    <p className="font-medium mb-1">Perfect for:</p>
                    <p>{config?.suitableFor || 'Services requiring specific appointment times (venues, entertainers, face painters)'}</p>
                  </div>
                </div>
              </div>
            </CardContent>
