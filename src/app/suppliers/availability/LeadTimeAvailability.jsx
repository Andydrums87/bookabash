...
import { Package, Clock, Info, Truck, Check, Calendar, AlertCircle, Settings, Users, Building2 } from "lucide-react"
      ...
      <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col space-y-4 sm:flex-row sm:justify-between sm:items-start sm:space-y-0">
            <div className="space-y-2">
              ...
              <p className="text-sm sm:text-base text-gray-600">
                Configure lead times and processing requirements for your {getCategoryDisplayName().toLowerCase()} business
              </p>
          ...
          <Card className="border-purple-200 bg-purple-50">
            <CardContent className="p-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-purple-900 mb-2">{config?.name || 'Lead Time Based'} Availability</h3>
                  <p className="text-sm text-purple-800 mb-3">{config?.description || 'Availability based on lead times and stock levels'}</p>
        ...
        <Tabs defaultValue="lead-times" className="w-full">
          <div className="px-4 sm:px-6 pb-0">
            <TabsList className="w-full grid grid-cols-4 p-1 rounded-lg h-auto bg-white border border-gray-200">
              <TabsTrigger
                value="lead-times"
          ...
          <TabsContent value="lead-times" className="p-4 sm:p-6 space-y-6">
            <Card>
              <CardHeader className="py-6 bg-gradient-to-r from-blue-50 to-blue-100">
              ...
              <CardContent className="p-6 space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    <Label htmlFor="min-lead-time" className="text-base font-semibold">
                    ...
                    <p className="text-sm text-gray-600">
                      Minimum days needed for standard orders
                    </p>
                  </div>

                  <div className="space-y-3">
                    <Label htmlFor="max-lead-time" className="text-base font-semibold">
                    ...
                    />
                    <p className="text-sm text-gray-600">
                      Maximum time for complex orders
                    </p>
                  </div>
                </div>

                <div className="space-y-3">
                  <Label htmlFor="custom-lead-time" className="text-base font-semibold">
                ...
                <div className="space-y-4 p-6 bg-orange-50 rounded-xl">
                  <div className="flex items-center space-x-3">
                    <Checkbox
                      ...
                      className="w-5 h-5"
                    />
                    <Label htmlFor="rush-orders" className="text-base font-medium">
                  ...
                  {leadTimeSettings.rushOrdersAvailable && (
                    <div className="ml-8 grid md:grid-cols-2 gap-6">
                      <div className="space-y-3">
                        <Label className="text-sm font-semibold">Rush order fee (£)</Label>
                        <Input
                          type="number"
                          min="0"
                          step="0.50"
                ...
                <div className="space-y-3">
                  <Label htmlFor="processing-notes" className="text-base font-semibold">
                  ...
                  />
                  <p className="text-sm text-gray-600">
                    Explain your processing requirements to customers
                  </p>
                </div>
              </CardContent>
            </Card>
          ...
          <TabsContent value="stock" className="p-4 sm:p-6 space-y-6">
            <Card>
              <CardHeader className="py-6 bg-gradient-to-r from-green-50 to-green-100">
                <CardTitle className="flex items-center gap-3 text-xl">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3 p-4 bg-gray-50 rounded-xl">
                    <Checkbox
                      ...
                      className="w-5 h-5"
                    />
                    <Label htmlFor="stock-based" className="text-base font-medium flex-1">
                      Track stock levels (recommended for physical products)
                    </Label>
                  </div>

                  {leadTimeSettings.stockBased && (
                    <div className="ml-6 space-y-6 p-6 bg-green-50 rounded-xl">
                      <div className="flex items-center space-x-3">
                        <Checkbox
                          id="unlimited-stock"
                          ...
                          className="w-5 h-5"
                        />
                        <Label htmlFor="unlimited-stock" className="text-base font-medium">
                      ...
                      {!leadTimeSettings.unlimitedStock && (
                        <div className="grid md:grid-cols-2 gap-6">
                          <div className="space-y-3">
                            <Label htmlFor="stock-quantity" className="text-base font-semibold">
                          ...
                          <div className="space-y-3">
                            <Label htmlFor="restock-days" className="text-base font-semibold">
                              Restock time (days)
                            </Label>
                            <Input
                              id="restock-days"
                        ...
                        {['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'].map(day => (
                          <div key={day} className="flex items-center space-x-3 p-3 bg-white rounded-lg">
                            <Checkbox
                              ...
                              className="w-4 h-4"
                            />
                            <Label htmlFor={`delivery-${day}`} className="text-sm font-medium capitalize cursor-pointer">
                              {day.slice(0, 3)}
                            </Label>
                          </div>
                        ))}
              ...
              <CardContent className="p-6 space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    ...
                    />
                    <p className="text-sm text-gray-600">
                      Extra buffer time before your lead time kicks in
                    </p>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    />
                    <p className="text-sm text-gray-600">
                      How far ahead customers can place orders
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  />
                  <p className="text-sm text-gray-600">
                    Share any other important information about your availability
                  </p>
                </div>
